...
(mapcar #'(lambda (x) (add-im-rule x 'postprocessRules))  ;; sets of rules are tagged so they can be managed independently 
	'(
	  ...
	  ; exclude all subtypes of CAUSE-EFFECT
	  ((ONT::EVENT ?!ev ONT::CREATE :TYPE (? t ONT::ALLOW ONT::CAUSE-PRODUCE-REPRODUCE ONT::CAUSE-STIMULATE ONT::ENABLE ONT::ENCOURAGE ONT::ENSURE ONT::HAVE-INFLUENCE ONT::HELP ONT::MAINTAIN-KEEP ONT::MAKE-IT-SO ONT::PROVOKE ONT::START ONT::TRY) )
	   -noop2>
	   100
	   (ONT::EVENT ?!ev ONT::NOOP
	    :rule -noop2
